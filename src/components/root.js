...
// Import Data
import spData from '../../data/SP500.json';
import trumpData from '../../data/formattedTrump.json';
import vixData from '../../data/VIXCLS.json';
import nasdaqData from '../../data/NASDAQCOM.json';
import tnyrData from '../../data/DGS10.json';
import djiaData from '../../data/DJIA.json';
import crudeoilData from '../../data/DCOILWTICO.json';
